...
let DepartmentsController = class DepartmentsController {
    ...
    setUserById1(departmentId, userId) {
        return this.departmentsService.setUserById(departmentId, userId);
    }
    setUserById(departmentId, userId) {
        return this.departmentsService.setUserById(departmentId, userId);
    }
...
__decorate([
    (0, common_1.Get)(':departmentId/users/userId'),
    __param(0, (0, common_1.Param)('departmentId')),
    __param(1, (0, common_1.Param)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", void 0)
], DepartmentsController.prototype, "setUserById1", null);
__decorate([
    (0, common_1.Patch)(':departmentId/users/userId'),
    __param(0, (0, common_1.Param)('departmentId')),
    __param(1, (0, common_1.Param)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", void 0)
], DepartmentsController.prototype, "setUserById", null);
__decorate([
    (0, common_1.Delete)(':departmentId/users'),
    __param(0, (0, common_1.Param)('studentId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], DepartmentsController.prototype, "unsetUserById", null);
